...
const About: React.FC = () => {
  ...
  const impactStats = [
    { value: '40+', label: t('about.impact.experience'), icon: '📈' },
    { value: '150K+', label: t('about.impact.daily'), icon: '🛢️' },
    { value: '1,200+', label: t('about.impact.employees'), icon: '👥' },
    { value: '99.8%', label: t('about.impact.safety'), icon: '🛡️' },
  ];
